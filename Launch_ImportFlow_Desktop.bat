@echo off
title Sorour Logistics ERP Desktop
setlocal

echo ====================================================
echo   Sorour Logistics ERP - Windows Desktop App
echo ====================================================
echo.

:: Free port 28080 if already in use
echo Freeing port 28080 if occupied...
...
echo Launching Sorour Logistics Desktop Application...
if exist "%~dp0frontend\build\windows\x64\runner\Release\frontend.exe" (
    ...
    start "Sorour Logistics Desktop" cmd /k "cd /d %~dp0frontend && flutter run -d windows"
)
