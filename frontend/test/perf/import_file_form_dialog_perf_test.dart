...
void main() {
  ...
  group('Modal Dialog: ImportFileFormDialog Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: ImportFileFormDialog(fileToEdit: sampleFile),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('MODAL (ImportFileFormDialog) BENCHMARK RESULTS:');
