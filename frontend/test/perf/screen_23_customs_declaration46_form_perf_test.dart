...
void main() {
  ...
  group('Screen 23: CustomsDeclaration46Screen (Tab 0: New Declaration 46 Form) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: CustomsDeclaration46Screen(initialSubTab: 0),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 23 (CustomsDeclaration46Screen - Form Tab 0) BENCHMARK RESULTS:');
