...
import 'package:frontend/features/customs_tariff/screens/customs_tariff_screen.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  group('Screen 45: CustomsTariffScreen HS Explorer & Duty Calc Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: CustomsTariffScreen(initialTabIndex: 1),
              ),
            ),
          ),
        ),
      ...
      debugPrint('Screen 45 Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
