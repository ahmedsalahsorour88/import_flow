...
void main() {
  ...
  group('Screen 12: NafezaAcidScreen (Tab 1: MTS Smart AI Parser) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: NafezaAcidScreen(initialSubTab: 1),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 12 Diagnostics ===');
