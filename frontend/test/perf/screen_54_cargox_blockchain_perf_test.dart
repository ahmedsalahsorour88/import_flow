...
void main() {
  ...
  group('Screen 54: OriginalDocsAndCargoXScreen (CargoX Blockchain) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: OriginalDocsAndCargoXScreen(initialSubTab: 1),
              ),
            ),
          ),
        ),
      ...
      debugPrint('Screen 54 Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
