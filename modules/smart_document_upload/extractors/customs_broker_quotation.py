...
PORT_NAME_MAP: Dict[str, str] = {
    "alexandria": "Alexandria Port (ميناء الإسكندرية)",
    "alex": "Alexandria Port (ميناء الإسكندرية)",
    "اسكندرية": "Alexandria Port (ميناء الإسكندرية)",
    "الإسكندرية": "Alexandria Port (ميناء الإسكندرية)",
    "dekheila": "El Dekheila Port (ميناء الدخيلة)",
    "الدخيلة": "El Dekheila Port (ميناء الدخيلة)",
    "sokhna": "Sokhna Port (ميناء السخنة)",
    "السخنة": "Sokhna Port (ميناء السخنة)",
    "عين السخنة": "Sokhna Port (ميناء السخنة)",
    "port said": "Port Said (ميناء بورسعيد)",
    "بورسعيد": "Port Said (ميناء بورسعيد)",
    "شرق بورسعيد": "East Port Said (شرق بورسعيد)",
    "غرب بورسعيد": "West Port Said (غرب بورسعيد)",
    "damietta": "Damietta Port (ميناء دمياط)",
    "دمياط": "Damietta Port (ميناء دمياط)",
    "adabiya": "Adabiya Port (ميناء الأدبية)",
    "الأدبية": "Adabiya Port (ميناء الأدبية)",
    "cairo airport": "Cairo Airport (مطار القاهرة الدولي)",
    "مطار القاهرة": "Cairo Airport (مطار القاهرة الدولي)",
    "6th of october": "6th of October Dry Port (الميناء الجاف بأكتوبر)",
    "أكتوبر الجاف": "6th of October Dry Port (الميناء الجاف بأكتوبر)",
}
