...
void main() {
  ...
  group('Screen 6: CustomsConsultationScreen (Tab 0: Customs Workspace) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: CustomsConsultationScreen(initialIndex: 0),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 6 Diagnostics ===');
