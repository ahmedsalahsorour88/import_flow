...
void main() {
  group('Screen 11: Nafeza & ACID Operations Localization Tests', () {
    ...
    final screen11Getters = <String, List<String>>{
      ...
      'commercialInvoiceLabel': [ar.commercialInvoiceLabel, en.commercialInvoiceLabel],
      'proformaInvoiceLabel': [ar.proformaInvoiceLabel, en.proformaInvoiceLabel],
      'acidSessionDeletedSuccess': [ar.acidSessionDeletedSuccess('ACID-001'), en.acidSessionDeletedSuccess('ACID-001')],
      'acidSessionLoadedForEdit': [ar.acidSessionLoadedForEdit('ACID-001'), en.acidSessionLoadedForEdit('ACID-001')],
      'mtsExtractedDataUpdated': [ar.mtsExtractedDataUpdated, en.mtsExtractedDataUpdated],
      'errorSavingDraft': [ar.errorSavingDraft, en.errorSavingDraft],
      'errorSavingAcid': [ar.errorSavingAcid, en.errorSavingAcid],
      'errorDeletingAcid': [ar.errorDeletingAcid, en.errorDeletingAcid],
      'errorCustomsComparison': [ar.errorCustomsComparison, en.errorCustomsComparison],
      'errorCertifyingAcid': [ar.errorCertifyingAcid, en.errorCertifyingAcid],
      'errorParsingMts': [ar.errorParsingMts, en.errorParsingMts],
      'errorCodingSupplier': [ar.errorCodingSupplier, en.errorCodingSupplier],
      'foreignSupplierNotInData': [ar.foreignSupplierNotInData, en.foreignSupplierNotInData],
      'supplierCodedSuccess': [ar.supplierCodedSuccess('Test Exp'), en.supplierCodedSuccess('Test Exp')],
      'acidRequestUpdatedSuccess': [ar.acidRequestUpdatedSuccess('ACID-001'), en.acidRequestUpdatedSuccess('ACID-001')],
      'acidRequestSavedSuccess': [ar.acidRequestSavedSuccess, en.acidRequestSavedSuccess],
      'acidCertifiedSuccess': [ar.acidCertifiedSuccess, en.acidCertifiedSuccess],
      'mtsNoticeDisclaimerAlertTitle': [ar.mtsNoticeDisclaimerAlertTitle, en.mtsNoticeDisclaimerAlertTitle],
      'mtsNoticeDisclaimerAlertContent': [ar.mtsNoticeDisclaimerAlertContent, en.mtsNoticeDisclaimerAlertContent],
      'mtsNoticeNoAcidAlertTitle': [ar.mtsNoticeNoAcidAlertTitle, en.mtsNoticeNoAcidAlertTitle],
      'mtsNoticeNoAcidAlertContent': [ar.mtsNoticeNoAcidAlertContent, en.mtsNoticeNoAcidAlertContent],
      'loadSampleMtsAndExtract': [ar.loadSampleMtsAndExtract, en.loadSampleMtsAndExtract],
      'loadSampleMtsAndTest': [ar.loadSampleMtsAndTest, en.loadSampleMtsAndTest],
      'acidExtractedSuccess': [ar.acidExtractedSuccess('1234567890123456789'), en.acidExtractedSuccess('1234567890123456789')],
      'selectImportFileFirst': [ar.selectImportFileFirst, en.selectImportFileFirst],
      'pasteMtsTextFirst': [ar.pasteMtsTextFirst, en.pasteMtsTextFirst],
      'selectImportFileToVerify': [ar.selectImportFileToVerify, en.selectImportFileToVerify],
      'whatsAppMessageCopied': [ar.whatsAppMessageCopied, en.whatsAppMessageCopied],
      'acidRequestCopied': [ar.acidRequestCopied, en.acidRequestCopied],
      'emailTemplateCopied': [ar.emailTemplateCopied, en.emailTemplateCopied],
      'discrepancyOverrideReasonHint': [ar.discrepancyOverrideReasonHint, en.discrepancyOverrideReasonHint],
      'mtsNotificationHint': [ar.mtsNotificationHint, en.mtsNotificationHint],
      'vatRegType': [ar.vatRegType, en.vatRegType],
      'crRegType': [ar.crRegType, en.crRegType],
      'taxIdRegType': [ar.taxIdRegType, en.taxIdRegType],
      'dunsRegType': [ar.dunsRegType, en.dunsRegType],
      'companyRegNumberType': [ar.companyRegNumberType, en.companyRegNumberType],
      'foreignExporterNafezaType': [ar.foreignExporterNafezaType, en.foreignExporterNafezaType],
      'factoryRegType': [ar.factoryRegType, en.factoryRegType],
      'poLabelPrefix': [ar.poLabelPrefix, en.poLabelPrefix],
    };
