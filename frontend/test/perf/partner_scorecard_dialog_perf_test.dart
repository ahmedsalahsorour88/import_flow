...
class _MockScorecardAdapter implements HttpClientAdapter {
  @override
  Future<ResponseBody> fetch(
    ...
    final payload = {
      ...
      'performance_tier': 'Platinum Elite',
      'star_rating': 4.8,
      'total_jobs_evaluated': 42,
      'evaluation_summary_ar': 'شريك ممتاز يتميز بالتزام فائق باتفاقيات مستوى الخدمة (SLA) وسرعة استجابة استثنائية.',
      'metrics': {
        'avg_clearance_turnaround_days': 2.1,
        'green_channel_rate_pct': 92.5,
        'sla_adherence_rate_pct': 98.0,
        'avg_arrival_delay_days': 0.4,
        'schedule_reliability_pct': 96.5,
      },
      'strengths': [
        'تخليص جمركي فوري بنسبة مسار أخضر تتجاوز 90%',
        'التزام دقيق بالمواعيد وموثوقية ملاحية عالية',
        'تواصل رقمي فوري وتحديثات بوالص الشحن آلياً',
      ],
      'improvement_areas': [
        'تحديث رسوم النولون الإضافية في وقت مبكر لتفادي فروقات التكلفة',
      ],
    };
...
Dio _createTestDio() {
  ...
  dio.httpClientAdapter = _MockScorecardAdapter();
  return dio;
}
...
void main() {
  ...
  group('Modal Dialog: PartnerScorecardDialog Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: PartnerScorecardDialog(
                  providerId: 303,
                  providerName: 'Maersk Line Egypt',
                  providerType: 'Shipping Line',
                ),
              ),
            ),
          ),
      ...
      debugPrint('==================================================');
      debugPrint('MODAL (PartnerScorecardDialog) BENCHMARK RESULTS:');
