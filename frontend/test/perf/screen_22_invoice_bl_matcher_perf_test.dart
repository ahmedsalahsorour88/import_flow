...
void main() {
  ...
  group('Screen 22: ShipmentDraftDocsScreen (Tab 3: Smart Invoice vs B/L Match) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: ShipmentDraftDocsScreen(initialSubTab: 3),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 22 (ShipmentDraftDocsScreen - Smart Invoice vs B/L Match) BENCHMARK RESULTS:');
