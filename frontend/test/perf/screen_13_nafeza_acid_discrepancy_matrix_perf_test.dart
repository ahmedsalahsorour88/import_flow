...
void main() {
  ...
  group('Screen 13: NafezaAcidScreen (Tab 2: Discrepancy Matrix) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: NafezaAcidScreen(initialSubTab: 2),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 13 Diagnostics ===');
