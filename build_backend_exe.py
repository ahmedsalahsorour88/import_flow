...
def build_backend():
    ...
    hidden_imports = [
        ...
        "main",
        "database.database",
        "database.master_data_sync_service",
        "database.schema_upgrade_service",
        "utils.migration_linter",
        "utils.crypto_utils",
        "modules.common.concurrency",
        "modules.system_observability.daily_report_service",
