...
void main() {
  ...
  group('Screen 10: FinancialApprovalScreen (Tab 2: Saved Budgets Registry) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: FinancialApprovalScreen(initialIndex: 2),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 10 Diagnostics ===');
