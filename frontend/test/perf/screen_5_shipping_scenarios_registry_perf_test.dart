...
void main() {
  ...
  group('Screen 5: ShippingScenariosScreen (Tab 1: Saved Scenarios Registry) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: ShippingScenariosScreen(initialIndex: 1),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 5 Diagnostics ===');
