...
void main() {
  ...
  group('Screen 26: CargoShippingScreen Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: CargoShippingScreen(initialSubTab: 0),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 26 (CargoShippingScreen - Allocations VGM) BENCHMARK RESULTS:');
