...
def write_model():
    target_path = r"frontend/lib/features/shipping_scenarios/models/shipping_scenario_model.dart"
    
    content = """class ShippingScenarioItemModel {
  final int? itemId;
...
"""
    ...
    print("Rewrote shipping_scenario_model.dart successfully!")
