...
def build_clean_production_db():
    ...
    try:
        ...
        # ==================================================
        # 6. Seed Core International Shipping Lines (MD-009B)
        # ==================================================
        print("[6/6] Seeding Core International Shipping Lines (MD-009B)...")
        shipping_lines_data = [
        ...
        print(f" - Shipping Lines:      {db.query(ExternalServiceProvider).count()} (MD-009B)")
