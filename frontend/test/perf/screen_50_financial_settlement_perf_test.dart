...
import 'package:frontend/features/financial_settlement/screens/landed_cost_comparison_screen.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  group('Screen 50: FinancialSettlementScreen Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: FinancialSettlementScreen(),
              ),
            ),
          ),
        ),
      ...
      debugPrint('Screen 50 Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
    ...
    testWidgets('Measure Dimension A and Dimension B on LandedCostComparisonScreen across 3 runs', (tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
        ...
        ProviderScope(
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: LandedCostComparisonScreen(),
              ),
            ),
          ),
        ),
      ...
      for (var i = 1; i <= 3; i++) {
        ...
        debugPrint('LandedCostComparison Run #$i: Nav-IN (First Frame): ${firstFrameMs}ms | Settled: ${settledMs}ms | Nav-OUT: ${navOutMs}ms');
      }
      ...
      debugPrint('Screen 50 LandedCostComparison Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
