...
void main() {
  ...
  group('Screen 64: InboundWarehouseHubScreen (Warehouse Shipments Report) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: InboundWarehouseHubScreen(initialSubTab: 2),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 64 (InboundWarehouseHubScreen - Report) BENCHMARK RESULTS:');
