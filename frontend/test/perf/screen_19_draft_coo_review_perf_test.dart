...
void main() {
  ...
  group('Screen 19: ShipmentDraftDocsScreen (Tab 4: Draft COO / EUR.1 Review) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: ShipmentDraftDocsScreen(initialSubTab: 4),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 19 (ShipmentDraftDocsScreen - Draft COO / EUR.1 Review) BENCHMARK RESULTS:');
