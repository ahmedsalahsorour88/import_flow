...
void main() {
  ...
  group('Screen 55: CustomsConsultationScreen (Clearance Quotes & AI) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs (Tab 2: Broker Price Lists & Quotes)', (tester) async {
      ...
      for (var i = 1; i <= 3; i++) {
        ...
        debugPrint('Run #$i (Tab 2): Nav-IN (First Frame): ${firstFrameMs}ms | Settled: ${settledMs}ms | Nav-OUT: ${navOutMs}ms');
      }
      ...
      debugPrint('Screen 55 (Tab 2) Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
    ...
    testWidgets('Measure Dimension A and Dimension B across 3 runs (Tab 3: Clearance Quotes & AI Extractor)', (tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      for (var i = 1; i <= 3; i++) {
        ...
        debugPrint('Run #$i (Tab 3): Nav-IN (First Frame): ${firstFrameMs}ms | Settled: ${settledMs}ms | Nav-OUT: ${navOutMs}ms');
      }
      ...
      debugPrint('Screen 55 (Tab 3) Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
