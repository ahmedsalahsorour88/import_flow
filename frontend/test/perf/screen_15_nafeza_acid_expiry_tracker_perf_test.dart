...
void main() {
  ...
  group('Screen 15: NafezaAcidScreen (Tab 4: Expiry Tracker) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
            ...
            child: const MaterialApp(
              home: AppLocalizationsProvider(
                ...
                child: Directionality(
                  ...
                  child: NafezaAcidScreen(initialSubTab: 4),
                ),
              ),
            ),
          ),
      ...
      debugPrint('=== Summary Screen 15 Diagnostics ===');
