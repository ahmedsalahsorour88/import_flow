...
void main() {
  ...
  group('Screen 24: CustomsDeclaration46Screen (Tab 1: Declaration 46 Registry) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: CustomsDeclaration46Screen(initialSubTab: 1),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 24 (CustomsDeclaration46Screen - Registry Tab 1) BENCHMARK RESULTS:');
