...
void main() {
  ...
  group('Screen 18: ShipmentDraftDocsScreen (Tab 2: Draft B/L Review) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: ShipmentDraftDocsScreen(initialSubTab: 2),
              ),
            ),
          ),
        ),
      ...
      debugPrint('==================================================');
      debugPrint('SCREEN 18 (ShipmentDraftDocsScreen - Draft B/L Review) BENCHMARK RESULTS:');
