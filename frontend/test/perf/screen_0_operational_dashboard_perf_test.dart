...
void main() {
  ...
  group('Screen 0: OperationalDashboardScreen Performance Diagnostics', () {
    testWidgets('Measure Dimension A (Navigation IN) & Dimension B (Navigation OUT) across 3 runs', (tester) async {
      ...
      for (var i = 1; i <= 3; i++) {
        ...
        // Dimension A: Mount / Navigation IN
        ...
        // Dimension B: Unmount / Navigation OUT (Pop/Dispose)
      ...
      debugPrint('=== Summary Screen 0 Diagnostics ===');
