...
void main() {
  ...
  group('Screen 53: ShipmentDraftDocsScreen (Draft Inspection Cert) Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: ShipmentDraftDocsScreen(initialSubTab: 5),
              ),
            ),
          ),
        ),
      ...
      debugPrint('Screen 53 Benchmark: First Frame: ${avgFirstFrame.toStringAsFixed(1)}ms | Settled: ${avgSettled.toStringAsFixed(1)}ms | Nav-OUT: ${avgNavOut.toStringAsFixed(1)}ms');
