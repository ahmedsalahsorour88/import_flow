...
import 'package:frontend/features/import_files/widgets/close_shipment_dialog.dart';
...
class _MockHttpAdapter implements HttpClientAdapter {
  ...
  Future<ResponseBody> fetch(
    ...
    return ResponseBody.fromString(
      jsonEncode({'message': 'Shipment closed successfully'}),
      200,
...
void main() {
  ...
  group('Modal Dialog: CloseShipmentDialog Performance Diagnostics', () {
    testWidgets('Measure Dimension A and Dimension B across 3 runs', (tester) async {
          ...
          child: const MaterialApp(
            home: AppLocalizationsProvider(
              ...
              child: Directionality(
                ...
                child: CloseShipmentDialog(
                  importFileId: 101,
                  importFileCode: 'IMP-2026-0001',
                  currentPhaseName: 'Phase 4 - Cargo Shipping',
                ),
              ),
            ),
          ),
      ...
      debugPrint('==================================================');
      debugPrint('MODAL (CloseShipmentDialog) BENCHMARK RESULTS:');
